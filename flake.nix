    ...
    let
      ...
      assets = {
        x86_64-linux = {
          ...
          hash = "sha256-eI6g1kIRWrr1AU/ApwMgs4UPlmEZT2yK2oSQqkghl3o=";
        };
        aarch64-darwin = {
          asset = "uvacompute-macos";
          hash = "sha256-jcPmZMCSQuygS9PN8sOk5ptm2JdKcoXcrRpsYaJ9vPg=";
        };
      };

      manPageHash = "sha256-BG3eaJFe6gHzlK6lC2gP4xJXcMRT9FppS07lYv5m360=";
    in
    {
