    ...
    let
      ...
      assets = {
        x86_64-linux = {
          ...
          hash = "sha256-H8JPDbXLUhynuKu14CwfWSX1dkVE2MR2K2XH4K6rkDY=";
        };
        aarch64-darwin = {
          asset = "uvacompute-macos";
          hash = "sha256-CR7t/i0a12J+lNPxm+BdPD/BmUyZXy/zZ77dzE97v8U=";
        };
      };

      manPageHash = "sha256-JKhEqYdblEDLMO5Dr5rji0Iit4w75BTI+rJJHi6h1Ko=";
    in
    {
